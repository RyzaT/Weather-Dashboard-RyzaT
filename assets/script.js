...
$(document).ready(function () {
    ...
    // Search API for City
    function search() {
        //var queryURL= "http://api.openweathermap.org/geo/1.0/direct?q=" + city + "&limit=5&appid=0f94ac327c16ba8cc2bceed87c2ec5f3";

        //var queryURL= "http://api.openweathermap.org/geo/1.0/direct?q={city name},{state code},{country code}&limit={limit}&appid=0f94ac327c16ba8cc2bceed87c2ec5f3";
        let queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial&appid=0f94ac327c16ba8cc2bceed87c2ec5f3";
        let coordinates = [];
        ...
        function getUV(lat, lon) {
            ...
            $.ajax({
                url: "https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + lon + "&exclude=minutely,hourly" + "&units=imperial&appid=0f94ac327c16ba8cc2bceed87c2ec5f3",
                method: "GET"
            }).then(function (response) {
